...
export function QuickCaptureClient() {
  ...
  async function submit() {
    ...
    const response = await fetch('/api/onboarding/quick-capture', {
      ...
      body: JSON.stringify({ firstMedicationTime, nextVisitDate, prescriptionPhotoUploadFailed: photoSkipped }),
    });
  ...
  return (
    <section className={styles.choiceSection} aria-labelledby="quick-capture-title">
      ...
      <label className="field-label" htmlFor="prescription-photo-skip">처방전/약 봉투 사진</label>
