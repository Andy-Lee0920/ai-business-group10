-- P1 schedule/protocol metadata closure: confirmed cards may carry user-confirmed time/date/share metadata.
-- This keeps draft suggestions inert until confirm_capture receives explicit user-confirmed items.
