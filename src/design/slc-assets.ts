...
export const slcAssets = {
  ...
  home: {
    ...
    injectionWide: decorativeAsset('/assets/slc/home-injection-bg-v2.png', 1131, 277),
    clinic: decorativeAsset('/assets/slc/home-clinic-bg.png', 371, 427),
    clinicWide: decorativeAsset('/assets/slc/home-clinic-bg-v2.png', 1121, 263),
    waiting: decorativeAsset('/assets/slc/home-waiting-bg.png', 370, 427),
    empty: decorativeAsset('/assets/slc/home-empty-bg.png', 373, 428),
