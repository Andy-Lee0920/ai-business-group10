...
const photoFrameStyle = { width: '100%', aspectRatio: '1 / 1', background: 'rgba(247,239,233,0.72)' } as const;
const photoGridStyle = { display: 'grid', gridTemplateColumns: 'repeat(2, minmax(0, 1fr))', gap: 2, width: '100%', aspectRatio: '1 / 1', background: 'rgba(247,239,233,0.72)' } as const;
...
const postBodyStyle = { color: 'var(--slc-text)', fontSize: 15, fontWeight: 850, lineHeight: 1.52, margin: '13px 14px 0', whiteSpace: 'pre-wrap' } as const;
const postActionRowStyle = { display: 'flex', alignItems: 'center', gap: 12, margin: '12px 14px 0' } as const;
